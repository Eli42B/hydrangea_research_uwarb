...
#Oh no, Jude's aggregation doesn't seem to be quite working. The month and dates aren't matching up, and the species doesn't make sense... we're gonna have to relook at this. 
...
#Calculating how long each cultivar potentially could be attracting insects and added it to our exported csv file  
...
d_per_month1 = read.csv("d_per_month4.csv")
...
### MAKING A PLOT TO VISUALIZE THE DAYS PER MONTH THAT EACH CULTIVAR WAS VISITED AT LEAST ONCE, COLORED BY panicle shape
...
#Here's a more elegant example of this using pipes 
starwars %>%
