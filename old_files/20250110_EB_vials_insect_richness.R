...
#try package inext designed to do this, it'll generate all the spp. estimators with confidence intervals around it standard package
...
######## Old species accumulation by hand ########################3
